...
import { orderByNumber } from '../../services/slices/feed/actions';
...
export const OrderInfo: FC = () => {
  ...
  const ingredients: TIngredient[] = useSelector(getIngredientsSelect);

  useEffect(() => {
    dispatch(orderByNumber(Number(orderNumber)));
